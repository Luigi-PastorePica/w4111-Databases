CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_new_person`(IN uni VARCHAR(12), IN last_name VARCHAR(64), IN first_name VARCHAR(64), IN person_type VARCHAR(1), IN graduation_year YEAR(4), IN title VARCHAR(20))
BEGIN
